...
"""Handle records from /proc/net/udp6 data files"""
...
def re_net_udp6(inprecs):
    """Handle parsed data from /proc/net/udp6 file"""
...
RG.RECREATOR[PH.GET_HANDLER("/proc/net/udp6")] = re_net_udp6
